...
//
//class ArrayPortStreamReader[T <: Data](port: ArrayTokenReadMaster[T]) extends Module {}
//
//class ArrayPortStreamReaderIO[T <: Data](genData: T, genToken: ArrayToken[T]) extends Bundle {
//  val _port = new ArrayTokenReadMaster(genData, genToken)
...
//
//class ArrayPortStreamReaderStatic[T <: Data](port: ArrayTokenReadMaster[T], readAddrSeq: Seq[Int]) extends ArrayPortStreamReader(port){
...
//  def apply[T <: Data](port: ArrayTokenReadMaster[T], readSeq: Seq[Int]) : ArrayPortStreamReaderStaticIO[T] = {
